...
Melhores_Lojas = avg_sales_per_store.nlargest(19,'Weekly_Sales')
...
fig_dept.update_layout(title='Vendas Médias por Departamento', xaxis_title='Data', yaxis_title='Vendas Semanais')
...
with col1:
    if selected_dept != 'Média Geral' or selected_store != 'Média Geral':
        ...
        fig_avg_sales_per_store_department.update_layout(title='Vendas Médias por Departamento', xaxis_title='Data', yaxis_title='Vendas Semanais')
